...
Production secrets belong only in the host's environment settings (e.g. Render/Vercel project env vars), never in source control. .gitignore should exclude .env*, local DB files, venv, and node_modules.
